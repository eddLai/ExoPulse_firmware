...
# problem 
  ...
  Your bleak v2.1.1 is incompatible with your BlueZ v5.53.
                                                                                                                                                   
  Bleak 2.1.1 requires BlueZ 5.56+ because it reads a Roles property that only exists in newer BlueZ. When the scanner runs, it crashes with       
  KeyError: 'Roles' before it can even find your EMG devices. That's why you get no data - it never actually connects.   